...
Blockly.Blocks['inout_digital_read'] = {
  ...
  init: function() {
    ...
    this.setTooltip('Lee el valor de un pin digital especificado, alta o baja');
  }
};
...
Blockly.Blocks['inout_analog_read'] = {
  ...
  init: function() {
    ...
    this.setOutput(true, 'Number');
    this.setTooltip('Valor de retorno entre 0 y 1024');
  }
};
...
Blockly.Blocks['inout_analog_write'] = {
  init: function() {
    ...
    this.setTooltip('Escribir el valor a un puerto analogico específico');
  }
};
...
Blockly.Blocks['inout_buildin_led'] = {
   ...
   init: function() {
     ...
     this.setTooltip('luz o fuera de la incorporada en el LED');
   }
};
...
Blockly.Blocks['inout_digital_write'] = {
  ...
  init: function() {
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('Escribir el valor digital a un puerto específico');
  }
};