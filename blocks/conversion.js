...
Blockly.Blocks['conversion_tochar'] = {
  init: function() {
    ...
    this.setTooltip('Convierte valores a char.');
...
Blockly.Blocks['conversion_tobyte'] = {
  init: function() {
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('Convierte valores a Byte. ');
...
Blockly.Blocks['conversion_toint'] = {
  init: function() {
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('Convierte valores a entero. ');
...
Blockly.Blocks['conversion_tofloat'] = {
  init: function() {
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('Convierte valores a flotante. ');
