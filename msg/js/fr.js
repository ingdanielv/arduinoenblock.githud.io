...
Blockly.Msg.INPOUT_DIGITAL_WRITE="Escritura digital PIN#";
Blockly.Msg.INOUT_STAT="STAT";
Blockly.Msg.INOUT_DIG_READ="Lectura digital PIN#";
Blockly.Msg.INOUT_BUI_LED="integra LED de STAT";
Blockly.Msg.INOUT_ANA_READ="Lectura analogica PIN#";
Blockly.Msg.INOUT_ANA_WRITE="Escritura analogica";
Blockly.Msg.INOUT_VALUE="Valor";


//SERIAL
Blockly.Msg.Serial_Print="Mostrar en una linea nueva";
Blockly.Msg.Serial_PrintL="Mostrar en la misma linea";
Blockly.Msg.Serial_Write="Escritura serial";
Blockly.Msg.Serial_write_out="Escritura";
Blockly.Msg.Serial_Print_Format="mostrar formato";
Blockly.Msg.Serial_Print_ForDecimal="decimal";
Blockly.Msg.Serial_Print_ForHexa="Hexadecimal";
Blockly.Msg.Serial_Print_ForBin="Binaria";
Blockly.Msg.Serial_Print_ForOct="Octal";
Blockly.Msg.Serial_read="Lectura serial";
Blockly.Msg.Serial_avai="Serial Disponible?";
Blockly.Msg.Serial_flush="Serial fin de transmicion";

//SOFTWARE SERIAL
Blockly.Msg.SSERIAL_Init="INIT";
Blockly.Msg.SSERIAL_TX="TX#";
Blockly.Msg.SSERIAL_RX="RX#";
Blockly.Msg.SSERIAL_Read="SoftwareSerial Lectura";
Blockly.Msg.SSERIAL_Print="SoftwareSerial Mostrar";
Blockly.Msg.SSERIAL_Write="SoftwareSerial Escritura";
...
Blockly.Msg.SERVO_ReadDegree="Lectura grados";
Blockly.Msg.SERVO_Attached="Servo conectado?";
Blockly.Msg.SERVO_Detach="Desconectar Servo PIN#";

//LCD
Blockly.Msg.LCD_Serial="Serial LCD";
Blockly.Msg.LCD_Print_Line1="pantalla linea 1";
Blockly.Msg.LCD_Print_Line2="pantalla linea 2";
Blockly.Msg.Power="Power";
Blockly.Msg.ONN="ON";
Blockly.Msg.OFFF="OFF";
Blockly.Msg.LCD_Effect="Efecto";
Blockly.Msg.LCD_Scroll_Left="Desplazamiento a la izquierda";
Blockly.Msg.LCD_Scroll_Right="Desplazamiento a la derecha";
Blockly.Msg.LCD_Scroll_Auto="Desplazamiento Automatico";

//VARIOUS
Blockly.Msg.VAR_TemSens="Captura de temperatura";
...
Blockly.Msg.Backward="Atrazo";
Blockly.Msg.DelayMs="Delay Ms";
Blockly.Msg.SinceProgramStarted="el programa comienza desde";
Blockly.Msg.RandomBetween="Numero aleatorio entre";
Blockly.Msg.And="y";
Blockly.Msg.Constrain="Restringuir";
Blockly.Msg.Number="numero";
Blockly.Msg.NumberA="A";
Blockly.Msg.NumberB="B";
Blockly.Msg.PulseIn="Pulso en";
Blockly.Msg.ultrasonic_ranger="Captura Ultrason";
Blockly.Msg.unit="Unidad";
Blockly.Msg.cm="cm";
Blockly.Msg.inch="pulgadas";
Blockly.Msg.TRIG="TRIG Disparo";
Blockly.Msg.Echo="Echo"; 

//LOOPS
Blockly.Msg.Break = "Interrupcion";
Blockly.Msg.continue = "Continua";
Blockly.Msg.returnnull = "FRetorna";

//VARIABLES 
Blockly.Msg.Var_Declare="Declare";
Blockly.Msg.Var_As="como";

//Math "Map "
Blockly.Msg.Math_map="Transformar "; 
Blockly.Msg.Math_valueto="valor [0-";

//STRING SET
Blockly.Msg.STRING_SET = "Establecer string %1 a %2";
Blockly.Msg.STRING_SET_CREATE_GET = "crear string 'obtener %1'";
Blockly.Msg.STRING_SET_HELPURL = "https://github.com/google/blockly/wiki/Variables#set";
Blockly.Msg.STRING_SET_TOOLTIP = "FRestablebcer este string para entradas iguales";
Blockly.Msg.RENAME_VARIABLE = "renombre la variable...";
Blockly.Msg.String_As="como string";
Blockly.Msg.STRING_charat="char de %1 a %2";
Blockly.Msg.STRING_charat2="char At";
Blockly.Msg.STRING_compareTo="para comparar";
Blockly.Msg.STRING_Contact="Concadenar ";
Blockly.Msg.STRING_LengthOf="Longuitud de ";
Blockly.Msg.STRING_Ends_With="Termine con  ";
Blockly.Msg.STRING_Equal="Para igualdad ";


//Conversions
Blockly.Msg.CONV_tochar="Convertir a char "; 
Blockly.Msg.CONV_tobyte="Convertir a Byte ";
Blockly.Msg.CONV_toint="Convertir a Int ";
Blockly.Msg.CONV_tofloat="Convertir a Float ";

// Advanced IO
Blockly.Msg.TonePin="Tono PIN#";
Blockly.Msg.Frequence="Frecuencia";
Blockly.Msg.Duration="Duracion";
Blockly.Msg.NoTonePin="No tono PIN#";
Blockly.Msg.Setup="Inicio";
Blockly.Msg.Loop="Ciclo principal";
