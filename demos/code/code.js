...
mystartfile +=  '<block type="clpegs_setup" x="0" y="0"></block>';
mystartfile += '</xml>';
...
Code.initLanguage = function() {
  ...
  var categories = ['catInOut','catSerial','catSoftSerial','catServo','catSerialLCD','catDigital','catAnalog', 
