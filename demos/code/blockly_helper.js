...
function saveCode() {
 ...
 //
    var d = new Date();
  var fileName = window.prompt('Como te gustaria que se llame tu archivo?', 'CLPEGS_'+'_'+d.getMinutes()+d.getMilliseconds())
...
function save() {
  ...
  var fileName = window.prompt('Como te gustaria que se llame tu archivo?', 'CLPEGS_XML');
  // Store data in blob.
...
function load(event) {
    //ADDEL
    //var fileName = window.prompt('§PPPP?', 'cplegs');
